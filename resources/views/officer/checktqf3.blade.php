...
@section('content')
                ...
                <div class="col-lg-12 mx-auto">
                    <div class="card">
                        <div class="card-header align-items-center">
                            <div class="pull-left">
                                <h4 class="h5">ตรวจสอบมคอ.3</h4>
                            </div>
                            {{-- <div class="row exports-tqf5  align-items-center" style="float: right;margin-right: 10px">
                                    <button type="button" onclick="export_tqf3()"
                                        class="btn btn-primary btn-sm">Export</button>
                                </div> --}}
                            <div class="row exports-tqf5  align-items-center" style="float: right;margin-right: 10px">
                                <button type="button" data-toggle="modal" data-target="#exportTQF3"
                                    class="btn btn-primary btn-sm">สรุปผลมคอ.3</button>
                            </div>
                        </div>
                        <div class="card-body table-tqf3">
                            ...
                            <div class="form-group row"
                                ...
                                <div class="col-sm-4">
                                    <select class="form-control" name="select_year">
                                        <option data-text="" value="" disabled selected>ภาคเรียนทั้งหมด</option>
                            ...
                            {{-- <div class="table-responsive" id="show-tqf3"> --}}

                            {{-- <table id="example" class="table table-bordered" style="width:100%;display:none;">
                                    ...
                                    <tbody id="checktqf3">
                                        @foreach ($data as $item)
                                            ...
                                            <tr>
                                                ...
                                                @if ($item->filetqf3 != '')
                                                    <td colspan="7">
                                                        <center>ส่งไฟล์มคอ. 3 *กรุณาตรวจเอกสาร</center>
                                                    </td>
    ...
    <div class="modal fade" id="exportTQF3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">สรุปผลการจัดทำรายละเอียดของรายวิชา (มคอ.3)</h5>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" onclick="export_tqf3()">Export</button>
    ...
    <div class="modal fade" id="status3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
...
@section('script')
    <script>
        ...
        $('#exportTQF3').on('show.bs.modal', function(e) {
            console.log(check_year);
            $('#exportTQF3 #select-year').val(check_year);
        });
        ...
        function load() {
            var year = $('.table-tqf3').find('select[name=select_year]').val();
            var group = $('.table-tqf3').find('select[name=select_group]').val();
            var user = $('.table-tqf3').find('[name=select_user]').val();
            var branch = $('.table-tqf3').find('select[name=select_branch]').val();
