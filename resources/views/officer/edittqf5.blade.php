...
@section('m3', 'active')
@section('e5', 'active')
@section('textpage', 'จัดการข้อมูลมคอ.5')

@section('content')
    <section class="tables">
        <div class="container-fluid">
            <div class="showtqf5 row">

                <div class="col-lg-12 mx-auto">
                    <div class="card">
                        <div class="card-header align-items-center ">
                            <div class="pull-left">
                                <h4 class="h5">จัดการข้อมูลมคอ.5</h4>
                            </div>
                            <div class="pull-right">
                                <button class="btn btn-info" data-target="#addfasttqf5"
                                    data-toggle="modal">เพิ่มแบบรวดเร็ว</button>
                                <button class="btn btn-success" data-target="#addtqf5" data-toggle="modal">เพิ่ม</button>
                            </div>
                        </div>
                        <div class="card-body ">
                                            ...
                                            <tr>
                                                ...
                                                <td
                                                    ...
                                                    <button class="btn btn-success btn-sm rounded-1" type="button"
                                                        onclick="edit_TQF5({{ $item }})" data-toggle="modal"
                                                        data-target="#edittqf5" title="แก้ไข">
                                                        <i class="fa fa-edit"></i></button>

                                                    <button class="btn btn-danger btn-sm rounded-1" type="button"
                                                        onclick="deletetqf5({{ $item->tqf5ID }})" data-toggle="tooltip" 
    ...
    <!-- Modal -->
    <div class="addtqf modal fade bd-example-modal-xl" id="addfasttqf5" tabindex="-1" role="dialog"
        aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">เพิ่มมคอ.5 แบบรวดเร็ว</h5>
                                            ...
                                            <tr>
                                                <td style="text-align: center;vertical-align: middle;">
                                                    <input data-user="{{ $item->iduser }}"
                                                        ...
                                                        style="width: 15px;height: 15px;" id="row-addtqf" class="custom-control-input" type="checkbox"
                                                        name="row-addtqf">
                                                </td>
                                                <td>{{ $item->subyear->term }}/{{ $item->subyear->Year }}</td>
                                                <td>{{ $item->subsubject->subjectCode }}</td>
                ...
                <div class="modal-footer">
                    <button class="btn btn-success addfast-tqf5" type="button">บันทึก</button>
    ...
    <div class="addtqf modal fade" id="addtqf5" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">เพิ่มมคอ.5</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                ...
                <div class="modal-footer">
                    <button class="btn btn-success" type="button" onclick="savetqf5()">เพิ่ม</button>
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">ปิดออก</button>
                </div>
            </div>
        </div>
                                    ...
                                    <td class="tqfstatus">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input"
                                                id="checkbox5-{{ $item->idsubject }}" name="row-check5"
                                                value="{{ $item->idsubject }}">
                                            <label class="custom-control-label"
                                                for="checkbox5-{{ $item->idsubject }}"></label>
                                        </div>
                            ...
                            @foreach ($group as $item)
                                <tr>
                                    <td class="tqfstatus">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input"
                                                id="checkboxt5-{{ $item->groupID }}" name="row-group5"
                                                value="{{ $item->groupID }}">
                                            <label class="custom-control-label"
                                                for="checkboxt5-{{ $item->groupID }}"></label>
                                        </div>
                                    </td>
    ...
    <div class="edittqf modal fade" id="edittqf5" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">แก้ไขมคอ.5</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form class="formtqf5 form-horizontal" method="post">
                        @csrf
                        <input name="idtqf5" type="hidden" value="0">
                        ...
                        {{-- <div class="form-group">class="selectpicker" data-live-search="true"
                                title="Please select"
                ...
                <div class="modal-footer">
                    <button type="button" onclick="edittqf5()" class="btn btn-success">บันทึก</button>
    ...
    <div class="modal fade" id="selectgroup" tabindex="-1" role="dialog" aria-labelledby="addsubLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                            ...
                            @foreach ($teacher as $no => $teach)
                                <tr>
                                    <td class="tqfstatus">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input"
                                                id="teacher5-{{ $teach->userID }}" name="row-teacher5"
                                                value="{{ $teach->userID }}">
                                            <label class="custom-control-label"
                                                for="teacher5-{{ $teach->userID }}"></label>
                                        </div>
                                    </td>
...
@section('script')
    <script>
        ...
        function load_fast_tqf5() {
            $.ajax({
                type: "get",
                url: "/tqf/addfastqf5?year=" + $('#data_year').val(),
                dataType: "html",
                success: function(response) {
                    $('#addfasttqf5 .show_tqf').html(response);
                    $('#example').DataTable();
                    id = []
                    var table = $('#example1').DataTable();
                    table.clear().draw();
        ...
        $('#addfasttqf5').on('show.bs.modal', function() {
            $('#addfasttqf5 select#year').val(dd_year)
            load_fast_tqf5()
        });

        $('#addtqf5').on('show.bs.modal', function() {
            $('#addtqf5 select#tqf_year').val(dd_year)
            $('select[name="tqf_year"]').selectpicker('refresh');
        })

        $('#addfasttqf5').on('hidden.bs.modal', function() {
            input = []
            id = [];
        });

        $('.addfast-tqf5').on('click', function() {

            var _token = $('#addfasttqf5 input[name=_token]').val();
            var term5_id = $('#addfasttqf5 select[name=year]').val();
            var date = $('#addfasttqf5 input[id=date]').val();
            // console.log(date)
            const check_date1 = $('#addfasttqf5 #data_year option:selected').text().trim().split("/");
            const check_date2 = $('#addfasttqf5 select[name=year] option:selected').text().trim().split("/");
