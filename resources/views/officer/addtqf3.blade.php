                ...
                <div class="col-md-9 mx-auto">
                    <div class="card">
                        <div class="card-header d-flex align-items-center">
                            <h4 class="h5">เพิ่มมคอ.3</h4>
                        </div>
                        <div class="formtqf3 card-body">
                            <form class="form-horizontal" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="year" id="year" class="form-control selectpicker" data-live-search="true"
                                ...
                                <br>
                                <center>
                                    <button class="btn btn-success w-100" type="button" onclick="savetqf3()">เพิ่ม</button>
                                </center>
                            </form>
                        </div>
                    </div>
                                        ...
                                        <ul class="list-inline m-0">
                                            <li class="list-inline-item">
                                                <button id="selectyear" class="btn btn-success btn-sm rounded-1"
                                                    type="button"
                                                    onclick="select3_term({{ $item->idYear }},'{{ $item->term }}/{{ $item->Year }}');">
                                                    เลือก
                                                </button>
                                            </li>
                                        </ul>
    ...
    <div class="modal fade" id="addsub" tabindex="-1" role="dialog" aria-labelledby="addsubLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table id="example2" class="table table-bordered" style="width:100%">
                        ...
                        <tbody>
                            @foreach ($sub as $item)
                                <tr>
                                    <td><input id="checkbox3" type="checkbox" name="row-check3"
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-btn btn-success btn-sm" data-dismiss="modal">เลือก</button>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <tbody>
                            @foreach ($teach as $no => $teacher)
                                <tr>
                                    ...
                                    <td class="tqfstatus">
                                        <!-- Call to action buttons -->
                                        <input id="checkboxt3" type="checkbox" name="row-teacher3"
                                    ...
                                    {{-- <ul class="list-inline m-0">
                                            <li class="list-inline-item">
                                                <button id="selectteacher" class="btn btn-success btn-sm rounded-1"
                                                    type="button"
                                                    onclick="select3_teacher({{ $teacher->userID }},'{{ $teacher->Uprefix }}{{ $teacher->UFName }} {{ $teacher->ULName }}')">
                                                    เลือก
                                                </button>
                                            </li>
                                        </ul> --}}
