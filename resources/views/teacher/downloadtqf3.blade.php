                        ...
                        <div class="card-header d-flex align-items-center">
                            <div class="col-lg-12 row">
                                ...
                                <div class="col-lg-3 col-md-3 p-0">
                                    <form class="form-inline" id="search" action="downloadtqf3" method="POST">
                                        @csrf
                            ...
                            {{-- <div class="row exports-tqf3" style="margin-right: 10px">
                                        ...
                                        <select id="select_year" name="select_year" style="width: 100px"
                                            ...
                                            @foreach ($year as $item)
                                                <option data-text="{{ $item->term }}/{{ $item->Year }}"
                                                    value="{{ $item->idYear }}">{{ $item->term }}/{{ $item->Year }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                            ...
                            {{-- <div class="form-row" style="margin-right: 10px">
                                ...
                                <div class="col-sm-2">
                                    <select id="select_sub" name="select_sub" style="width: 100px" class="form-control">
                                        <option data-text="" value="" selected></option>
                                        @foreach ($sub as $item)
                                            <option data-text="{{ $item->THsubject }}" value="{{ $item->idsubject }}">{{ $item->THsubject }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div> --}}
                                        ...
                                        <tr>
                                            ...
                                            <td
                                                ...
                                                @if ($item->send_file == 1)
                                                    ...
                                                    @endforeach
                                                @else
                                                    <a href="filetqf3/{{ $item->tqf3ID }}" target="_blank"><i
