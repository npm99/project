...
@section('content')
    <section class="tables">
        <div class="container-fluid">
            <div class="row">
                {{-- @include('template.termsearch') --}}
                <div class="col-lg-12 mx-auto">
                    <div class="card">
                        <div class="card-header d-flex align-items-center">
                            <div class="col-lg-12 row">
                                <div class="col-lg-10 col-md-12">
                                    <h4 class="h5">รายงานผลการดําเนินการของรายวิชา (มคอ.5)</h4>
                                </div>
                                <div class="col-lg-2 col-md-12">
                                    <form class="form-inline" id="search" action="tqf5" method="POST">
                                        @csrf
                                ...
                                <table id="example" class="table table-bordered" style="width:100%">
                                    <thead class="headtable">
                                        <tr>
                                            ...
                                            <th colspan="6">สถานะหมวดหมู่ มคอ.5</th>
                                    ...
                                    <tbody>
                                        @foreach ($tqf as $item)
                                            <tr>
                                                ...
                                                {{-- <td></td> --}}
                                                @if ($item->filetqf5 != '' && $item->send_file == 1 && $item->status != 4)
                                                    <td colspan="6">
                                                ...
                                                <td class="tqfstatus">
                                                    ...
                                                    <ul class="list-inline m-0">
                                                        {{-- @if ($item->status != 2) --}}
                                                        {{-- @if ($item->filetqf5 == '' || $item->filetqf5 == null) --}}
                                                        ...
                                                        @if ($item->status != 2 && $item->status != 1)
                                                            <li class="inline-item mb-1">
                                                                <button class="btn btn-dark btn-sm rounded-1 copy-tqf5"
                                                                    type="button" data-toggle="tooltip"
                                                                    data-id="{{ $item->tqf5ID }}" data-placement="top"
                                                                    title="คัดลอกมคอ.5">
            ...
            <div class="modal fade" id="addtqf5" tabindex="-1" role="dialog" aria-labelledby="addtqf3Label"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <button class="btn btn-primary btn-sm" type="button">
                                            <input type="file" id="filetqf" accept=".doc, .docx, .pdf"
                                                name="file[]" data-show-upload="false" data-show-caption="true"
                                                multiple>
                                        </button>
                        ...
                        <div class="modal-footer">
                            <button type="button" onclick="teacherFileTqf5()" class="btn btn-success">บันทึก</button>
            ...
            <div class="modal fade" id="copytqf5" tabindex="-1" role="dialog" aria-labelledby="copytqf5Label"
                aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h6 class="modal-title" id="copytqf5Label">คัดลอกมคอ. 5 <span id="title"></span></h6>
        ...
        @section('script')
            <script>
                ...
                $('.copy-tqf5').click(function(e) {
                    e.preventDefault();
                    var id = $(this).data('id');
                    $.ajax({
                        type: "get",
                        url: "/check_copytqf5/" + id,
                        // data: data,
                        // dataType: "json",
                        success: function(response) {
                            if (response.success) {
                                ...
                                $(".copytqf5").append(response.message);
                                // $("#copy-tqf5-submit").click();
                            } else {
                                Swal.fire({
                            ...
                            // $('#copy_form_tqf5').modal('show');
                        }
                    });
                });

                $('#copytqf5').on('hidden.bs.modal', function(e) {
                    $(".copytqf5").empty();
                })
